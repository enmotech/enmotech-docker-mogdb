...
Builds a Docker Image for MogDB
...
# MogDB Database Image Name
IMAGE_NAME="mogdb:$VERSION"
...
docker build --force-rm=true --no-cache=true \
  ...
  echo ""
  echo "ERROR: MogDB Database Docker Image was NOT successfully created."
...
cat << EOF
  MogDB Docker Image  $VERSION is ready to be extended: 
